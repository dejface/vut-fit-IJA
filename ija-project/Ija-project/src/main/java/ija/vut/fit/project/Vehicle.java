       ...
       /* if(onStopCount == 10) {
        ...
        if(getOnStopCount() == 10 | getOnStopCount() == 0){
           ...
           // System.out.println(time);
            if (this.line == 1){
                if (timelines.get(0).getTimeList().get(stopCountLine1).equals(time.toString())){
                    for (Stop s : stops) {
                    ...
                    if ((stopCountLine1 != timelines.get(0).getTimeList().size()-1)){
                        stopCountLine1++;
                    }
                    System.out.println(stopCountLine1);
                }
            } else if (this.line == 2){
                if (timelines.get(0).getTimeList().get(stopCountLine2).equals(time.toString())){
                    for (Stop s : stops) {
                        if (Math.abs(coords.getX() - s.getCoordinates().getX()) <= 3 &
                                Math.abs(coords.getY() - s.getCoordinates().getY()) <= 3) {
                            setOnStopCount(onStopCount - 1);
                    ...
                    if ((stopCountLine2 != timelines.get(0).getTimeList().size()-1)){
                        stopCountLine2++;
                    }
                }
            } else if (this.line == 3){
                if (timelines.get(0).getTimeList().get(stopCountLine3).equals(time.toString())){
                    for (Stop s : stops) {
                        if (Math.abs(coords.getX() - s.getCoordinates().getX()) <= 3 &
                                Math.abs(coords.getY() - s.getCoordinates().getY()) <= 3) {
                            setOnStopCount(onStopCount - 1);
                    ...
                    if ((stopCountLine3 != timelines.get(0).getTimeList().size()-1)){
                        stopCountLine3++;
                    }
                }
            } else if (this.line == 4){
                if (timelines.get(0).getTimeList().get(stopCountLine4).equals(time.toString())){
                    for (Stop s : stops) {
                        if (Math.abs(coords.getX() - s.getCoordinates().getX()) <= 3 &
                                Math.abs(coords.getY() - s.getCoordinates().getY()) <= 3) {
                            setOnStopCount(onStopCount - 1);
                    ...
                    if ((stopCountLine4 != timelines.get(0).getTimeList().size()-1)){
                        stopCountLine4++;
                    }
                }
            }
